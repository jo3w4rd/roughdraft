...
using Markdig.Renderers.GDoc.Inlines;
...
namespace Markdig.Renderers
{
    ...
    public class GDocRenderer : TextRendererBase<GDocRenderer>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GDocRenderer"/> class.
        /// </summary>
        /// <param name="writer">The writer.</param>
        public GDocRenderer(TextWriter writer, IClientService service) : base(writer)
        {
            // Default block renderers
            ObjectRenderers.Add(new CodeBlockRenderer());
            ObjectRenderers.Add(new ListRenderer());
            ObjectRenderers.Add(new HeadingRenderer());
            ObjectRenderers.Add(new GDocHTMLBlockRenderer());
            ...
            ObjectRenderers.Add(new GDocInlineRenderer());
            ObjectRenderers.Add(new GDocEntityInlineRenderer());            
        ...
        /// <summary>
        /// A request to add the content to a Google Doc
        /// </summary>
        ...
        new public GDocRenderer Write(string content, int offset, int length)
        {
            Console.WriteLine($"GDOCR Write(col): {content.Substring(offset,length)} : from {content.Length} {offset} {length}");
            return base.Write(content, offset, length);
        }

        new public GDocRenderer Write(ref StringSlice slice)
        {
            Console.WriteLine($"GDoc Write(ref slice): {slice.ToString()}");
            return base.Write(slice);
        }
        new public GDocRenderer Write(string? content)
        {
            Console.WriteLine($"GDOCR Write(c): {content}");
            return base.Write(content);
        }

        new public GDocRenderer Write(StringSlice slice)
        {
            Console.WriteLine($"GDOCR Write(slice): {slice.ToString()}");
            return base.Write(slice);
        }

        new public GDocRenderer Write(char content)
        {
            Console.WriteLine($"GDOCR Write(char): {content}");
            return base.Write(content);
        }

        new public GDocRenderer WriteLine()
        {
            Console.WriteLine($"GDOCR WriteLine() newline");
            return base.WriteLine();
        }

        new public GDocRenderer WriteLine(NewLine newLine)
        {
            Console.WriteLine($"GDOCR WriteLine(newline)");
            return base.WriteLine(newLine);
        }

        new public GDocRenderer WriteLine(string content)
        {
            Console.WriteLine($"GDOCR WriteLine(string): {content}");
            return base.WriteLine(content);
        }
        public GDocRenderer WriteLeafInline(LeafBlock leafBlock)
        {
            
            Console.WriteLine($"GDOCR WriteLeafInline(lb): {leafBlock.GetType()}");
            return base.WriteLeafInline(leafBlock);
        }
        /// <summary>
        ...
        public GDocRenderer WriteEscape(string? content)
        {
        ...
        /// <returns>This instance</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public GDocRenderer WriteEscape(ref StringSlice slice, bool softEscape = false)
        {
        ...
        /// <returns>This instance</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public GDocRenderer WriteEscape(StringSlice slice, bool softEscape = false)
        {
        ...
        /// <param name="softEscape">Only escape &lt; and &amp;</param>
        /// <returns>This instance</returns>
        public GDocRenderer WriteEscape(string content, int offset, int length, bool softEscape = false)
        {
        ...
        /// <param name="content">The content.</param>
        /// <returns>This instance</returns>
        public GDocRenderer WriteEscapeUrl(string? content)
        {
            if (content is null)
                return this;
        ...
        /// <returns></returns>
        public GDocRenderer WriteAttributes(MarkdownObject markdownObject)
        {
            //if (markdownObject is null) ThrowHelper.ArgumentNullException_markdownObject();
            if (markdownObject is null) throw new ArgumentNullException("Markdown object is null.");
        ...
        /// <returns>This instance</returns>
        public GDocRenderer WriteAttributes(HtmlAttributes? attributes, Func<string, string>? classFilter = null)
        {
        ...
        /// <param name="softEscape">Only escape &lt; and &amp;</param>
        /// <returns>This instance</returns>
        public GDocRenderer WriteLeafRawLines(LeafBlock leafBlock, bool writeEndOfLines, bool escape, bool softEscape = false)
        {
            //if (leafBlock is null) ThrowHelper.ArgumentNullException_leafBlock();
            if (leafBlock is null) throw new ArgumentNullException("Null LeafBlock."); // TODO  use ThrowHelper
            if (leafBlock.Lines.Lines != null)
            {
                ...
                for (int i = 0; i < lines.Count; i++)
                {
                    ...
                    else
                    {
                        ...
                        Console.WriteLine($"GD: WriteLeafRawLines: {slices[i].Slice}");
                    }
                    if (writeEndOfLines)
                    {
                        WriteLine();
