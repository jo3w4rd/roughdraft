...
{
    /// <summary>
    /// An GDoc renderer for a <see cref="CodeBlock"/> and <see cref="FencedCodeBlock"/>.
    /// </summary>
    /// <seealso cref="GDocObjectRenderer{TObject}" />
    public class CodeBlockRenderer : GDocObjectRenderer<CodeBlock>
    {
        /// <summary>
        ...
        protected override void Write(GDocRenderer renderer, CodeBlock obj)
        {
            renderer.EnsureLine();
