...
namespace Markdig.Renderers.GDoc
{
    ...
    public class HtmlAttributes : MarkdownObject
    {
        ...
        public void AddClass(string name)
        {
            ...
            if (name is null) throw new ArgumentNullException("CSS class name string is null.");
        ...
        {
            //if (name is null) ThrowHelper.ArgumentNullException_name();
            if (name is null) throw new ArgumentNullException("Property name string is null.");
        ...
        public void CopyTo(HtmlAttributes htmlAttributes, bool mergeIdAndProperties = false, bool shared = true)
        {
            ...
            if (htmlAttributes is null) throw new ArgumentNullException("HTML attributes name string is null.");
